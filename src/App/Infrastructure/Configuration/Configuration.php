...
class Configuration implements ConfigurationInterface
{
    public function getConfigTreeBuilder()
    {
        ...
        $treeBuilder->getRootNode()
            ->children()
                ->arrayNode('attributes')->cannotBeEmpty()->useAttributeAsKey('code')
                    ->arrayPrototype()
                        ->children()
                            ->scalarNode('code')->end()
                            ->arrayNode('label')
                    ...
                    ->end()
                ->end()
                ->arrayNode('groups')->cannotBeEmpty()->useAttributeAsKey('code')
                    ->arrayPrototype()
                        ->children()
                            ->scalarNode('code')->end()
                            ->arrayNode('label')
                    ...
                    ->end()
                ->end()
                ->arrayNode('families')->cannotBeEmpty()->useAttributeAsKey('code')
                    ->arrayPrototype()
                        ->children()
                            ->scalarNode('code')->end()
                    ...
                    ->end()
                ->end()
                ->arrayNode('locales')->cannotBeEmpty()->useAttributeAsKey('code')
                    ->arrayPrototype()
                        ->children()
                            ->scalarNode('code')->end()
                    ...
                    ->end()
                ->end()
                ->arrayNode('scopes')->cannotBeEmpty()->useAttributeAsKey('code')
                    ->arrayPrototype()
                        ->children()
                            ->scalarNode('code')->end()
