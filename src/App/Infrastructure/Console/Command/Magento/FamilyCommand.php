...
class FamilyCommand extends Command
{
    protected static $defaultName = 'magento:families';
    ...
    {
        $this->setDescription('Generate the families fixtures files depending on your catalog.yaml configuration and your Magento data.');
