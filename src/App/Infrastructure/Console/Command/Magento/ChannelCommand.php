...
{
    protected static $defaultName = 'magento:channels';
    ...
    {
        $this->setDescription('Generate the channels fixtures files depending on your catalog.yaml configuration and your Magento data.');
