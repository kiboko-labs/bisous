...
{
    protected static $defaultName = 'magento:products';
    ...
    {
        $this->setDescription('Generate the product fixtures files depending on your catalog.yaml configuration and your Magento data.');
